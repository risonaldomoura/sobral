...
public class Tab_portugues_nono_ extends Fragment{
    ...
    Adaptador_Portugues_nono_I_Bimestre adp_portugues_nono_I;
    ...
    Adaptador_Portugues_nono_II_Bimestre adp_portugues_nono_II;
    ...
    Adaptador_Portugues_nono_III_Bimestre adp_portugues_nono_III;
    ...
    Adaptador_Portugues_nono_IV_Bimestre adp_portugues_nono_IV;
    ...
    public String disciplina = "portugues", ano = "9_ano", bimestre, position_firebase;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adp_portugues_nono_I = new Adaptador_Portugues_nono_I_Bimestre(listData_I_Bimestre);
        ...
        adp_portugues_nono_II = new Adaptador_Portugues_nono_II_Bimestre(listData_II_Bimestre);
        ...
        adp_portugues_nono_III = new Adaptador_Portugues_nono_III_Bimestre(listData_III_Bimestre);
        ...
        adp_portugues_nono_IV = new Adaptador_Portugues_nono_IV_Bimestre(listData_IV_Bimestre);
    ...
    public class SendRequest extends AsyncTask<String,Void,String> {
        ...
        protected String doInBackground(String... arg0){
            try{
                ...
                //postDataParams.put("text1", adp_portugues_nono_1_bimestre.listArray.get(0).getX());
                //postDataParams.put("text2", adp_portugues_nono_1_bimestre.listArray.get(1).getX());
                //postDataParams.put("text3", adp_portugues_nono_1_bimestre.listArray.get(2).getX());
                //postDataParams.put("text4", adp_portugues_nono_1_bimestre.listArray.get(3).getX());
                //postDataParams.put("text5", adp_portugues_nono_1_bimestre.listArray.get(4).getX());
    ...
    public void GetDataFirebase_I_Bimestre() {
        ...
        //------Titulo_I_Bimestre------//
        DBR_Titulo_I_Bimestre = FDB.getReferenceFromUrl("https://matriz-sobral-194718.firebaseio.com/disciplinas/portugues/9_ano/1_bimestre/titulo/0/x");
        ...
        //------Conteudo_I_Bimestre------//
        DBR = FDB.getReference("disciplinas").child("portugues").child("9_ano").child("1_bimestre").child("conteudo");
        DBR.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                rv_I_Bimestre.setAdapter(adp_portugues_nono_I);
    ...
    public class Adaptador_Portugues_nono_I_Bimestre extends RecyclerView.Adapter<Adaptador_Portugues_nono_I_Bimestre.ViewholderPortugues_nono_I_Bimestre> {

        List<MyDataGetSet> listArray_I;
        int  cont_act_1 = 1;

        public Adaptador_Portugues_nono_I_Bimestre(List<MyDataGetSet> List) {
            this.listArray_I = List;
        }

        @Override
        public ViewholderPortugues_nono_I_Bimestre onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_itemview_lista_conteudo, parent, false);

            return new ViewholderPortugues_nono_I_Bimestre(view);
        }

        //Aqui instancia a textview e a checkbox
        public class ViewholderPortugues_nono_I_Bimestre extends RecyclerView.ViewHolder {
            TextView myText;
            CheckBox mCB;
            LinearLayout layout_item_view;
            View mView;

            public ViewholderPortugues_nono_I_Bimestre(View itemView) {
                super(itemView);
                mView = itemView;
        ...
        @Override
        public void onBindViewHolder(final ViewholderPortugues_nono_I_Bimestre holder, final int position) {
        ...
        public void ExibeDialogOpcoes() {
            ...
            btn_abrir_anotacoes.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ((Main_activity) getActivity()).ano = "p_9ano";
                    String p = String.valueOf(position_check);
                    ((Main_activity) getActivity()).titulo = "p9a"+p+"_"+sTitulo_I_Bimestre;
    ...
    public void GetDataFirebase_II_Bimestre() {
        ...
        //------Titulo_II_Bimestre------//
        DBR_Titulo_II_Bimestre = FDB.getReferenceFromUrl("https://matriz-sobral-194718.firebaseio.com/disciplinas/portugues/9_ano/2_bimestre/titulo/0/x");
        ...
        DBR = FDB.getReference("disciplinas").child("portugues").child("9_ano").child("2_bimestre").child("conteudo");
        DBR.addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                rv_II_Bimestre.setAdapter(adp_portugues_nono_II);
    ...
    public class Adaptador_Portugues_nono_II_Bimestre extends RecyclerView.Adapter<Adaptador_Portugues_nono_II_Bimestre.ViewholderPortugues_nono_II_Bimestre> {

        List<MyDataGetSet> listArray_II;
        int cont_act_2 = 1;

        public Adaptador_Portugues_nono_II_Bimestre(List<MyDataGetSet> List) {
            this.listArray_II = List;
        }

        @Override
        public ViewholderPortugues_nono_II_Bimestre onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_itemview_lista_conteudo, parent, false);

            return new ViewholderPortugues_nono_II_Bimestre(view);
        }

        @Override
        public void onBindViewHolder(final Adaptador_Portugues_nono_II_Bimestre.ViewholderPortugues_nono_II_Bimestre holder, final int position) {
        ...
        //Aqui instancia a textview e a checkbox
        public class ViewholderPortugues_nono_II_Bimestre extends RecyclerView.ViewHolder {
            TextView myText;
            CheckBox mCB;
            LinearLayout layout_item_view;
            View mView;

            public ViewholderPortugues_nono_II_Bimestre(View itemView) {
                super(itemView);
                mView = itemView;
        ...
        public void ExibeDialogOpcoes() {
            ...
            btn_abrir_anotacoes.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ((Main_activity) getActivity()).ano = "p_9ano";
                    String p = String.valueOf(position_check);
                    ((Main_activity) getActivity()).titulo = "p9a"+p+"_"+sTitulo_II_Bimestre;
    ...
    public void GetDataFirebase_III_Bimestre() {
        ...
        //------Titulo_III_Bimestre------//
        DBR_Titulo_III_Bimestre = FDB.getReferenceFromUrl("https://matriz-sobral-194718.firebaseio.com/disciplinas/portugues/9_ano/3_bimestre/titulo/0/x");
        ...
        DBR = FDB.getReference("disciplinas").child("portugues").child("9_ano").child("3_bimestre").child("conteudo");
        DBR.addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                rv_III_Bimestre.setAdapter(adp_portugues_nono_III);
    ...
    public class Adaptador_Portugues_nono_III_Bimestre extends RecyclerView.Adapter<Adaptador_Portugues_nono_III_Bimestre.ViewholderPortugues_nono_III_Bimestre> {

        List<MyDataGetSet> listArray_III;
        int cont_act_3 = 1;

        public Adaptador_Portugues_nono_III_Bimestre(List<MyDataGetSet> List) {
            this.listArray_III = List;
        }

        @Override
        public ViewholderPortugues_nono_III_Bimestre onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_itemview_lista_conteudo, parent, false);

            return new ViewholderPortugues_nono_III_Bimestre(view);
        }

        @Override
        public void onBindViewHolder(final Adaptador_Portugues_nono_III_Bimestre.ViewholderPortugues_nono_III_Bimestre holder, final int position) {
        ...
        //Aqui instancia a textview e a checkbox
        public class ViewholderPortugues_nono_III_Bimestre extends RecyclerView.ViewHolder {
            TextView myText;
            CheckBox mCB;
            LinearLayout layout_item_view;
            View mView;

            public ViewholderPortugues_nono_III_Bimestre(View itemView) {
                super(itemView);
                mView = itemView;
        ...
        public void ExibeDialogOpcoes() {
            ...
            btn_abrir_anotacoes.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ((Main_activity) getActivity()).ano = "p_9ano";
                    String p = String.valueOf(position_check);
                    ((Main_activity) getActivity()).titulo = "p9a"+p+"_"+sTitulo_III_Bimestre;
    ...
    public void GetDataFirebase_IV_Bimestre() {
        ...
        //------Titulo_IV_Bimestre------//
        DBR_Titulo_IV_Bimestre = FDB.getReferenceFromUrl("https://matriz-sobral-194718.firebaseio.com/disciplinas/portugues/9_ano/4_bimestre/titulo/0/x");
        ...
        //------Conteudo_I_Bimestre------//
        DBR = FDB.getReference("disciplinas").child("portugues").child("9_ano").child("4_bimestre").child("conteudo");
        DBR.addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                rv_IV_Bimestre.setAdapter(adp_portugues_nono_IV);
    ...
    public class Adaptador_Portugues_nono_IV_Bimestre extends RecyclerView.Adapter<Adaptador_Portugues_nono_IV_Bimestre.ViewholderPortugues_nono_IV_Bimestre> {

        List<MyDataGetSet> listArray_IV;
        int  cont_act_4 = 1;

        public Adaptador_Portugues_nono_IV_Bimestre(List<MyDataGetSet> List) {
            this.listArray_IV = List;
        }

        @Override
        public ViewholderPortugues_nono_IV_Bimestre onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_itemview_lista_conteudo, parent, false);

            return new ViewholderPortugues_nono_IV_Bimestre(view);
        }

        //Aqui instancia a textview e a checkbox
        public class ViewholderPortugues_nono_IV_Bimestre extends RecyclerView.ViewHolder {
            TextView myText;
            CheckBox mCB;
            LinearLayout layout_item_view;
            View mView;

            public ViewholderPortugues_nono_IV_Bimestre(View itemView) {
                super(itemView);
                mView = itemView;
        ...
        @Override
        public void onBindViewHolder(final ViewholderPortugues_nono_IV_Bimestre holder, final int position) {
        ...
        public void ExibeDialogOpcoes() {
            ...
            btn_abrir_anotacoes.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ((Main_activity) getActivity()).ano = "p_9ano";
                    String p = String.valueOf(position_check);
                    ((Main_activity) getActivity()).titulo = "p9a"+p+"_"+sTitulo_IV_Bimestre;
    ...
    public void onViewCreated (View view, Bundle savedInstanceState) {
        ...
        ((Main_activity) getActivity()).tab_obj_port_nono_(view);
