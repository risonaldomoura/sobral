...
public class Tab_portugues_setimo_ extends Fragment{
    ...
    Adaptador_Portugues_setimo_I_Bimestre adp_portugues_setimo_I;
    ...
    Adaptador_Portugues_setimo_II_Bimestre adp_portugues_setimo_II;
    ...
    Adaptador_Portugues_setimo_III_Bimestre adp_portugues_setimo_III;
    ...
    Adaptador_Portugues_setimo_IV_Bimestre adp_portugues_setimo_IV;
    ...
    public String disciplina = "portugues", ano = "7_ano", bimestre, position_firebase;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adp_portugues_setimo_I = new Adaptador_Portugues_setimo_I_Bimestre(listData_I_Bimestre);
        ...
        adp_portugues_setimo_II = new Adaptador_Portugues_setimo_II_Bimestre(listData_II_Bimestre);
        ...
        adp_portugues_setimo_III = new Adaptador_Portugues_setimo_III_Bimestre(listData_III_Bimestre);
        ...
        adp_portugues_setimo_IV = new Adaptador_Portugues_setimo_IV_Bimestre(listData_IV_Bimestre);
    ...
    public void GetDataFirebase_I_Bimestre() {
        ...
        DBR.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                rv_I_Bimestre.setAdapter(adp_portugues_setimo_I);
    ...
    public class Adaptador_Portugues_setimo_I_Bimestre extends RecyclerView.Adapter<Adaptador_Portugues_setimo_I_Bimestre.ViewholderPortugues_setimo_I_Bimestre> {

        List<MyDataGetSet> listArray_I;
        int  cont_act_1 = 1;

        public Adaptador_Portugues_setimo_I_Bimestre(List<MyDataGetSet> List) {
            this.listArray_I = List;
        }

        @Override
        public ViewholderPortugues_setimo_I_Bimestre onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_itemview_lista_conteudo, parent, false);

            return new ViewholderPortugues_setimo_I_Bimestre(view);
        }

        //Aqui instancia a textview e a checkbox
        public class ViewholderPortugues_setimo_I_Bimestre extends RecyclerView.ViewHolder {
            TextView myText;
            CheckBox mCB;
            LinearLayout layout_item_view;
            View mView;

            public ViewholderPortugues_setimo_I_Bimestre(View itemView) {
                super(itemView);
                mView = itemView;
        ...
        @Override
        public void onBindViewHolder(final ViewholderPortugues_setimo_I_Bimestre holder, final int position) {
        ...
        public void ExibeDialogOpcoes() {
            ...
            btn_abrir_anotacoes.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ((Main_activity) getActivity()).ano = "p_7ano";
                    String p = String.valueOf(position_check);
                    ((Main_activity) getActivity()).titulo = "p7a"+p+"_"+sTitulo_I_Bimestre;
    ...
    public void GetDataFirebase_II_Bimestre() {
        ...
        DBR.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                rv_II_Bimestre.setAdapter(adp_portugues_setimo_II);
    ...
    public class Adaptador_Portugues_setimo_II_Bimestre extends RecyclerView.Adapter<Adaptador_Portugues_setimo_II_Bimestre.ViewholderPortugues_setimo_II_Bimestre> {

        List<MyDataGetSet> listArray_II;
        int cont_act_2 = 1;

        public Adaptador_Portugues_setimo_II_Bimestre(List<MyDataGetSet> List) {
            this.listArray_II = List;
        }

        @Override
        public ViewholderPortugues_setimo_II_Bimestre onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_itemview_lista_conteudo, parent, false);

            return new ViewholderPortugues_setimo_II_Bimestre(view);
        }

        @Override
        public void onBindViewHolder(final Adaptador_Portugues_setimo_II_Bimestre.ViewholderPortugues_setimo_II_Bimestre holder, final int position) {
        ...
        //Aqui instancia a textview e a checkbox
        public class ViewholderPortugues_setimo_II_Bimestre extends RecyclerView.ViewHolder {
            TextView myText;
            CheckBox mCB;
            LinearLayout layout_item_view;
            View mView;

            public ViewholderPortugues_setimo_II_Bimestre(View itemView) {
                super(itemView);
                mView = itemView;
        ...
        public void ExibeDialogOpcoes() {
            ...
            btn_abrir_anotacoes.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ((Main_activity) getActivity()).ano = "p_7ano";
                    String p = String.valueOf(position_check);
                    ((Main_activity) getActivity()).titulo = "p7a"+p+"_"+sTitulo_II_Bimestre;
    ...
    public void GetDataFirebase_III_Bimestre() {
        ...
        DBR.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                rv_III_Bimestre.setAdapter(adp_portugues_setimo_III);
    ...
    public class Adaptador_Portugues_setimo_III_Bimestre extends RecyclerView.Adapter<Adaptador_Portugues_setimo_III_Bimestre.ViewholderPortugues_setimo_III_Bimestre> {

        List<MyDataGetSet> listArray_III;
        int cont_act_3 = 1;

        public Adaptador_Portugues_setimo_III_Bimestre(List<MyDataGetSet> List) {
            this.listArray_III = List;
        }

        @Override
        public ViewholderPortugues_setimo_III_Bimestre onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_itemview_lista_conteudo, parent, false);

            return new ViewholderPortugues_setimo_III_Bimestre(view);
        }

        @Override
        public void onBindViewHolder(final Adaptador_Portugues_setimo_III_Bimestre.ViewholderPortugues_setimo_III_Bimestre holder, final int position) {
        ...
        //Aqui instancia a textview e a checkbox
        public class ViewholderPortugues_setimo_III_Bimestre extends RecyclerView.ViewHolder {
            TextView myText;
            CheckBox mCB;
            LinearLayout layout_item_view;
            View mView;

            public ViewholderPortugues_setimo_III_Bimestre(View itemView) {
                super(itemView);
                mView = itemView;
        ...
        public void ExibeDialogOpcoes() {
            ...
            btn_abrir_anotacoes.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ((Main_activity) getActivity()).ano = "p_7ano";
                    String p = String.valueOf(position_check);
                    ((Main_activity) getActivity()).titulo = "p7a"+p+"_"+sTitulo_III_Bimestre;
    ...
    public void GetDataFirebase_IV_Bimestre() {
        ...
        DBR.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                rv_IV_Bimestre.setAdapter(adp_portugues_setimo_IV);
    ...
    public class Adaptador_Portugues_setimo_IV_Bimestre extends RecyclerView.Adapter<Adaptador_Portugues_setimo_IV_Bimestre.ViewholderPortugues_setimo_IV_Bimestre> {

        List<MyDataGetSet> listArray_IV;
        int cont_act_4 = 1;

        public Adaptador_Portugues_setimo_IV_Bimestre(List<MyDataGetSet> List) {
            this.listArray_IV = List;
        }

        @Override
        public ViewholderPortugues_setimo_IV_Bimestre onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_itemview_lista_conteudo, parent, false);

            return new ViewholderPortugues_setimo_IV_Bimestre(view);
        }

        //Aqui instancia a textview e a checkbox
        public class ViewholderPortugues_setimo_IV_Bimestre extends RecyclerView.ViewHolder {
            TextView myText;
            CheckBox mCB;
            LinearLayout layout_item_view;
            View mView;

            public ViewholderPortugues_setimo_IV_Bimestre(View itemView) {
                super(itemView);
                mView = itemView;
        ...
        @Override
        public void onBindViewHolder(final ViewholderPortugues_setimo_IV_Bimestre holder, final int position) {
        ...
        public void ExibeDialogOpcoes() {
            ...
            btn_abrir_anotacoes.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ((Main_activity) getActivity()).ano = "p_7ano";
                    String p = String.valueOf(position_check);
                    ((Main_activity) getActivity()).titulo = "p7a"+p+"_"+sTitulo_IV_Bimestre;
