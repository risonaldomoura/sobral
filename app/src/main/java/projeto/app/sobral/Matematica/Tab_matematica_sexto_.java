...
public class Tab_matematica_sexto_ extends Fragment{
    ...
    Adaptador_Matematica_sexto_I_Bimestre adp_matematica_sexto_I;
    ...
    Adaptador_Matematica_sexto_II_Bimestre adp_matematica_sexto_II;
    ...
    Adaptador_Matematica_sexto_III_Bimestre adp_matematica_sexto_III;
    ...
    Adaptador_Matematica_sexto_IV_Bimestre adp_matematica_sexto_IV;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adp_matematica_sexto_I = new Adaptador_Matematica_sexto_I_Bimestre(listData_I_Bimestre);
        ...
        adp_matematica_sexto_II = new Adaptador_Matematica_sexto_II_Bimestre(listData_II_Bimestre);
        ...
        adp_matematica_sexto_III = new Adaptador_Matematica_sexto_III_Bimestre(listData_III_Bimestre);
        ...
        adp_matematica_sexto_IV = new Adaptador_Matematica_sexto_IV_Bimestre(listData_IV_Bimestre);
    ...
    public void GetDataFirebase_I_Bimestre() {
        ...
        DBR.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                rv_I_Bimestre.setAdapter(adp_matematica_sexto_I);
    ...
    public class Adaptador_Matematica_sexto_I_Bimestre extends RecyclerView.Adapter<Adaptador_Matematica_sexto_I_Bimestre.ViewholderMatematica_sexto_I_Bimestre> {

        List<MyDataGetSet> listArray_I;
        int cont_act_1 = 1;

        public Adaptador_Matematica_sexto_I_Bimestre(List<MyDataGetSet> List) {
            this.listArray_I = List;
        }

        @Override
        public ViewholderMatematica_sexto_I_Bimestre onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_itemview_lista_conteudo, parent, false);

            return new ViewholderMatematica_sexto_I_Bimestre(view);
        }

        //Aqui instancia a textview e a checkbox
        public class ViewholderMatematica_sexto_I_Bimestre extends RecyclerView.ViewHolder {
            TextView myText;
            CheckBox mCB;
            LinearLayout layout_item_view;
            View mView;

            public ViewholderMatematica_sexto_I_Bimestre(View itemView) {
                super(itemView);
                mView = itemView;
        ...
        @Override
        public void onBindViewHolder(final ViewholderMatematica_sexto_I_Bimestre holder, final int position) {
        ...
        public void ExibeDialogOpcoes() {
            ...
            btn_abrir_anotacoes.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ((Main_activity) getActivity()).ano = "m_6ano";
                    String p = String.valueOf(position_check);
                    ((Main_activity) getActivity()).titulo = "m6a"+p+"_"+sTitulo_I_Bimestre;
    ...
    public void GetDataFirebase_II_Bimestre() {
        ...
        DBR.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                rv_II_Bimestre.setAdapter(adp_matematica_sexto_II);
    ...
    public class Adaptador_Matematica_sexto_II_Bimestre extends RecyclerView.Adapter<Adaptador_Matematica_sexto_II_Bimestre.ViewholderMatematica_sexto_II_Bimestre> {

        List<MyDataGetSet> listArray_II;
        int cont_act_2 = 1;

        public Adaptador_Matematica_sexto_II_Bimestre(List<MyDataGetSet> List) {
            this.listArray_II = List;
        }

        @Override
        public ViewholderMatematica_sexto_II_Bimestre onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_itemview_lista_conteudo, parent, false);

            return new ViewholderMatematica_sexto_II_Bimestre(view);
        }

        @Override
        public void onBindViewHolder(final Adaptador_Matematica_sexto_II_Bimestre.ViewholderMatematica_sexto_II_Bimestre holder, final int position) {
        ...
        //Aqui instancia a textview e a checkbox
        public class ViewholderMatematica_sexto_II_Bimestre extends RecyclerView.ViewHolder {
            TextView myText;
            CheckBox mCB;
            LinearLayout layout_item_view;
            View mView;

            public ViewholderMatematica_sexto_II_Bimestre(View itemView) {
                super(itemView);
                mView = itemView;
        ...
        public void ExibeDialogOpcoes() {
            ...
            btn_abrir_anotacoes.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ((Main_activity) getActivity()).ano = "m_6ano";
                    String p = String.valueOf(position_check);
                    ((Main_activity) getActivity()).titulo = "m6a"+p+"_"+sTitulo_II_Bimestre;
    ...
    public void GetDataFirebase_III_Bimestre() {
        ...
        DBR.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                rv_III_Bimestre.setAdapter(adp_matematica_sexto_III);
    ...
    public class Adaptador_Matematica_sexto_III_Bimestre extends RecyclerView.Adapter<Adaptador_Matematica_sexto_III_Bimestre.ViewholderMatematica_sexto_III_Bimestre> {

        List<MyDataGetSet> listArray_III;
        int cont_act_3 = 1;

        public Adaptador_Matematica_sexto_III_Bimestre(List<MyDataGetSet> List) {
            this.listArray_III = List;
        }

        @Override
        public ViewholderMatematica_sexto_III_Bimestre onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_itemview_lista_conteudo, parent, false);

            return new ViewholderMatematica_sexto_III_Bimestre(view);
        }

        @Override
        public void onBindViewHolder(final Adaptador_Matematica_sexto_III_Bimestre.ViewholderMatematica_sexto_III_Bimestre holder, final int position) {
        ...
        //Aqui instancia a textview e a checkbox
        public class ViewholderMatematica_sexto_III_Bimestre extends RecyclerView.ViewHolder {
            TextView myText;
            CheckBox mCB;
            LinearLayout layout_item_view;
            View mView;

            public ViewholderMatematica_sexto_III_Bimestre(View itemView) {
                super(itemView);
                mView = itemView;
        ...
        public void ExibeDialogOpcoes() {
            ...
            btn_abrir_anotacoes.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ((Main_activity) getActivity()).ano = "m_6ano";
                    String p = String.valueOf(position_check);
                    ((Main_activity) getActivity()).titulo = "m6a"+p+"_"+sTitulo_III_Bimestre;
    ...
    public void GetDataFirebase_IV_Bimestre() {
        ...
        DBR.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                rv_IV_Bimestre.setAdapter(adp_matematica_sexto_IV);
    ...
    public class Adaptador_Matematica_sexto_IV_Bimestre extends RecyclerView.Adapter<Adaptador_Matematica_sexto_IV_Bimestre.ViewholderMatematica_sexto_IV_Bimestre> {

        List<MyDataGetSet> listArray_IV;
        int  cont_act_4 = 1;

        public Adaptador_Matematica_sexto_IV_Bimestre(List<MyDataGetSet> List) {
            this.listArray_IV = List;
        }

        @Override
        public ViewholderMatematica_sexto_IV_Bimestre onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_itemview_lista_conteudo, parent, false);

            return new ViewholderMatematica_sexto_IV_Bimestre(view);
        }

        //Aqui instancia a textview e a checkbox
        public class ViewholderMatematica_sexto_IV_Bimestre extends RecyclerView.ViewHolder {
            TextView myText;
            CheckBox mCB;
            LinearLayout layout_item_view;
            View mView;

            public ViewholderMatematica_sexto_IV_Bimestre(View itemView) {
                super(itemView);
                mView = itemView;
        ...
        @Override
        public void onBindViewHolder(final ViewholderMatematica_sexto_IV_Bimestre holder, final int position) {
        ...
        public void ExibeDialogOpcoes() {
            ...
            btn_abrir_anotacoes.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ((Main_activity) getActivity()).ano = "m_6ano";
                    String p = String.valueOf(position_check);
                    ((Main_activity) getActivity()).titulo = "m6a"+p+"_"+sTitulo_IV_Bimestre;
