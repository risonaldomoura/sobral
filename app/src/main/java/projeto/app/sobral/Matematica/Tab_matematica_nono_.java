...
public class Tab_matematica_nono_ extends Fragment{
    ...
    Adaptador_Matematica_nono_I_Bimestre adp_matematica_nono_I;
    ...
    Adaptador_Matematica_nono_II_Bimestre adp_matematica_nono_II;
    ...
    Adaptador_Matematica_nono_III_Bimestre adp_matematica_nono_III;
    ...
    Adaptador_Matematica_nono_IV_Bimestre adp_matematica_nono_IV;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adp_matematica_nono_I = new Adaptador_Matematica_nono_I_Bimestre(listData_I_Bimestre);
        ...
        adp_matematica_nono_II = new Adaptador_Matematica_nono_II_Bimestre(listData_II_Bimestre);
        ...
        adp_matematica_nono_III = new Adaptador_Matematica_nono_III_Bimestre(listData_III_Bimestre);
    ...
    public void GetDataFirebase_I_Bimestre() {
        ...
        DBR.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                rv_I_Bimestre.setAdapter(adp_matematica_nono_I);
    ...
    public class Adaptador_Matematica_nono_I_Bimestre extends RecyclerView.Adapter<Adaptador_Matematica_nono_I_Bimestre.ViewholderMatematica_nono_I_Bimestre> {
        ...
        public class ViewholderMatematica_nono_I_Bimestre extends RecyclerView.ViewHolder {
            TextView myText;
            CheckBox mCB;
            LinearLayout layout_item_view;
            View mView;

            public ViewholderMatematica_nono_I_Bimestre(View itemView) {
                super(itemView);
                mView = itemView;
        ...
        @Override
        public void onBindViewHolder(final ViewholderMatematica_nono_I_Bimestre holder, final int position) {
    ...
    public void GetDataFirebase_II_Bimestre() {
        ...
        DBR.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                rv_II_Bimestre.setAdapter(adp_matematica_nono_II);
    ...
    public class Adaptador_Matematica_nono_II_Bimestre extends RecyclerView.Adapter<Adaptador_Matematica_nono_II_Bimestre.ViewholderMatematica_nono_II_Bimestre> {
        ...
        @Override
        public void onBindViewHolder(final Adaptador_Matematica_nono_II_Bimestre.ViewholderMatematica_nono_II_Bimestre holder, final int position) {
        ...
        //Aqui instancia a textview e a checkbox
        public class ViewholderMatematica_nono_II_Bimestre extends RecyclerView.ViewHolder {
            TextView myText;
            CheckBox mCB;
            LinearLayout layout_item_view;
            View mView;

            public ViewholderMatematica_nono_II_Bimestre(View itemView) {
                super(itemView);
                mView = itemView;
    ...
    public void GetDataFirebase_III_Bimestre() {
        ...
        DBR.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                rv_III_Bimestre.setAdapter(adp_matematica_nono_III);
    ...
    public class Adaptador_Matematica_nono_III_Bimestre extends RecyclerView.Adapter<Adaptador_Matematica_nono_III_Bimestre.ViewholderMatematica_nono_III_Bimestre> {
        ...
        @Override
        public void onBindViewHolder(final Adaptador_Matematica_nono_III_Bimestre.ViewholderMatematica_nono_III_Bimestre holder, final int position) {
        ...
        //Aqui instancia a textview e a checkbox
        public class ViewholderMatematica_nono_III_Bimestre extends RecyclerView.ViewHolder {
            TextView myText;
            CheckBox mCB;
            LinearLayout layout_item_view;
            View mView;

            public ViewholderMatematica_nono_III_Bimestre(View itemView) {
                super(itemView);
                mView = itemView;
    ...
    public void GetDataFirebase_IV_Bimestre() {
        ...
        DBR.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                rv_IV_Bimestre.setAdapter(adp_matematica_nono_IV);
    ...
    public class Adaptador_Matematica_nono_IV_Bimestre extends RecyclerView.Adapter<Adaptador_Matematica_nono_IV_Bimestre.ViewholderMatematica_nono_IV_Bimestre> {
        ...
        //Aqui instancia a textview e a checkbox
        public class ViewholderMatematica_nono_IV_Bimestre extends RecyclerView.ViewHolder {
            TextView myText;
            CheckBox mCB;
            LinearLayout layout_item_view;
            View mView;

            public ViewholderMatematica_nono_IV_Bimestre(View itemView) {
                super(itemView);
                mView = itemView;
        ...
        @Override
        public void onBindViewHolder(final ViewholderMatematica_nono_IV_Bimestre holder, final int position) {
