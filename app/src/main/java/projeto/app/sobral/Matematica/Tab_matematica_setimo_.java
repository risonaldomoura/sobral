...
public class Tab_matematica_setimo_ extends Fragment{
    ...
    Adaptador_Matematica_setimo_I_Bimestre adp_matematica_setimo_I;
    ...
    Adaptador_Matematica_setimo_II_Bimestre adp_matematica_setimo_II;
    ...
    Adaptador_Matematica_setimo_III_Bimestre adp_matematica_setimo_III;
    ...
    Adaptador_Matematica_setimo_IV_Bimestre adp_matematica_setimo_IV;
    ...
    public String disciplina = "matematica", ano = "7_ano", bimestre, position_firebase;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adp_matematica_setimo_I = new Adaptador_Matematica_setimo_I_Bimestre(listData_I_Bimestre);
        ...
        adp_matematica_setimo_II = new Adaptador_Matematica_setimo_II_Bimestre(listData_II_Bimestre);
        ...
        adp_matematica_setimo_III = new Adaptador_Matematica_setimo_III_Bimestre(listData_III_Bimestre);
        ...
        adp_matematica_setimo_IV = new Adaptador_Matematica_setimo_IV_Bimestre(listData_IV_Bimestre);
    ...
    public class SendRequest extends AsyncTask<String,Void,String> {
        ...
        protected String doInBackground(String... arg0){
            try{
                ...
                //postDataParams.put("text1", adp_matematica_setimo_1_bimestre.listArray.get(0).getX());
                //postDataParams.put("text2", adp_matematica_setimo_1_bimestre.listArray.get(1).getX());
                //postDataParams.put("text3", adp_matematica_setimo_1_bimestre.listArray.get(2).getX());
               // postDataParams.put("text4", adp_matematica_setimo_1_bimestre.listArray.get(3).getX());
               // postDataParams.put("text5", adp_matematica_setimo_1_bimestre.listArray.get(4).getX());
    ...
    public void GetDataFirebase_I_Bimestre() {
        ...
        //------Titulo_I_Bimestre------//
        DBR_Titulo_I_Bimestre = FDB.getReferenceFromUrl("https://matriz-sobral-194718.firebaseio.com/disciplinas/matematica/7_ano/1_bimestre/titulo/0/x");
        ...
        //------Conteudo_I_Bimestre------//
        DBR = FDB.getReference("disciplinas").child("matematica").child("7_ano").child("1_bimestre").child("conteudo");
        DBR.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                rv_I_Bimestre.setAdapter(adp_matematica_setimo_I);
    ...
    public class Adaptador_Matematica_setimo_I_Bimestre extends RecyclerView.Adapter<Adaptador_Matematica_setimo_I_Bimestre.ViewholderMatematica_setimo_I_Bimestre> {

        List<MyDataGetSet> listArray_I;
        int cont_act_1 = 1;

        public Adaptador_Matematica_setimo_I_Bimestre(List<MyDataGetSet> List) {
            this.listArray_I = List;
        }

        @Override
        public ViewholderMatematica_setimo_I_Bimestre onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_itemview_lista_conteudo, parent, false);

            return new ViewholderMatematica_setimo_I_Bimestre(view);
        }

        //Aqui instancia a textview e a checkbox
        public class ViewholderMatematica_setimo_I_Bimestre extends RecyclerView.ViewHolder {
            TextView myText;
            CheckBox mCB;
            LinearLayout layout_item_view;
            View mView;

            public ViewholderMatematica_setimo_I_Bimestre(View itemView) {
                super(itemView);
                mView = itemView;
        ...
        @Override
        public void onBindViewHolder(final ViewholderMatematica_setimo_I_Bimestre holder, final int position) {
        ...
        public void ExibeDialogOpcoes() {
            ...
            btn_abrir_anotacoes.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ((Main_activity) getActivity()).ano = "m_7ano";
                    String p = String.valueOf(position_check);
                    ((Main_activity) getActivity()).titulo = "m7a"+p+"_"+sTitulo_I_Bimestre;
    ...
    public void GetDataFirebase_II_Bimestre() {
        ...
        //------Titulo_II_Bimestre------//
        DBR_Titulo_II_Bimestre = FDB.getReferenceFromUrl("https://matriz-sobral-194718.firebaseio.com/disciplinas/matematica/7_ano/2_bimestre/titulo/0/x");
        ...
        DBR = FDB.getReference("disciplinas").child("matematica").child("7_ano").child("2_bimestre").child("conteudo");
        DBR.addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                rv_II_Bimestre.setAdapter(adp_matematica_setimo_II);
    ...
    public class Adaptador_Matematica_setimo_II_Bimestre extends RecyclerView.Adapter<Adaptador_Matematica_setimo_II_Bimestre.ViewholderMatematica_setimo_II_Bimestre> {

        List<MyDataGetSet> listArray_II;
        int  cont_act_2 = 1;

        public Adaptador_Matematica_setimo_II_Bimestre(List<MyDataGetSet> List) {
            this.listArray_II = List;
        }

        @Override
        public ViewholderMatematica_setimo_II_Bimestre onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_itemview_lista_conteudo, parent, false);

            return new ViewholderMatematica_setimo_II_Bimestre(view);
        }

        @Override
        public void onBindViewHolder(final Adaptador_Matematica_setimo_II_Bimestre.ViewholderMatematica_setimo_II_Bimestre holder, final int position) {
        ...
        //Aqui instancia a textview e a checkbox
        public class ViewholderMatematica_setimo_II_Bimestre extends RecyclerView.ViewHolder {
            TextView myText;
            CheckBox mCB;
            LinearLayout layout_item_view;
            View mView;

            public ViewholderMatematica_setimo_II_Bimestre(View itemView) {
                super(itemView);
                mView = itemView;
        ...
        public void ExibeDialogOpcoes() {
            ...
            btn_abrir_anotacoes.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ((Main_activity) getActivity()).ano = "m_7ano";
                    String p = String.valueOf(position_check);
                    ((Main_activity) getActivity()).titulo = "m7a"+p+"_"+sTitulo_II_Bimestre;
    ...
    public void GetDataFirebase_III_Bimestre() {
        ...
        //------Titulo_III_Bimestre------//
        DBR_Titulo_III_Bimestre = FDB.getReferenceFromUrl("https://matriz-sobral-194718.firebaseio.com/disciplinas/matematica/7_ano/3_bimestre/titulo/0/x");
        ...
        DBR = FDB.getReference("disciplinas").child("matematica").child("7_ano").child("3_bimestre").child("conteudo");
        DBR.addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                rv_III_Bimestre.setAdapter(adp_matematica_setimo_III);
    ...
    public class Adaptador_Matematica_setimo_III_Bimestre extends RecyclerView.Adapter<Adaptador_Matematica_setimo_III_Bimestre.ViewholderMatematica_setimo_III_Bimestre> {

        List<MyDataGetSet> listArray_III;
        int  cont_act_3 = 1;

        public Adaptador_Matematica_setimo_III_Bimestre(List<MyDataGetSet> List) {
            this.listArray_III = List;
        }

        @Override
        public ViewholderMatematica_setimo_III_Bimestre onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_itemview_lista_conteudo, parent, false);

            return new ViewholderMatematica_setimo_III_Bimestre(view);
        }

        @Override
        public void onBindViewHolder(final Adaptador_Matematica_setimo_III_Bimestre.ViewholderMatematica_setimo_III_Bimestre holder, final int position) {
        ...
        //Aqui instancia a textview e a checkbox
        public class ViewholderMatematica_setimo_III_Bimestre extends RecyclerView.ViewHolder {
            TextView myText;
            CheckBox mCB;
            LinearLayout layout_item_view;
            View mView;

            public ViewholderMatematica_setimo_III_Bimestre(View itemView) {
                super(itemView);
                mView = itemView;
        ...
        public void ExibeDialogOpcoes() {
            ...
            btn_abrir_anotacoes.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ((Main_activity) getActivity()).ano = "m_7ano";
                    String p = String.valueOf(position_check);
                    ((Main_activity) getActivity()).titulo = "m7a"+p+"_"+sTitulo_III_Bimestre;
    ...
    public void GetDataFirebase_IV_Bimestre() {
        ...
        //------Titulo_IV_Bimestre------//
        DBR_Titulo_IV_Bimestre = FDB.getReferenceFromUrl("https://matriz-sobral-194718.firebaseio.com/disciplinas/matematica/7_ano/4_bimestre/titulo/0/x");
        ...
        //------Conteudo_I_Bimestre------//
        DBR = FDB.getReference("disciplinas").child("matematica").child("7_ano").child("4_bimestre").child("conteudo");
        DBR.addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                rv_IV_Bimestre.setAdapter(adp_matematica_setimo_IV);
    ...
    public class Adaptador_Matematica_setimo_IV_Bimestre extends RecyclerView.Adapter<Adaptador_Matematica_setimo_IV_Bimestre.ViewholderMatematica_setimo_IV_Bimestre> {

        List<MyDataGetSet> listArray_IV;
        int cont_act_4 = 1;

        public Adaptador_Matematica_setimo_IV_Bimestre(List<MyDataGetSet> List) {
            this.listArray_IV = List;
        }

        @Override
        public ViewholderMatematica_setimo_IV_Bimestre onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_itemview_lista_conteudo, parent, false);

            return new ViewholderMatematica_setimo_IV_Bimestre(view);
        }

        //Aqui instancia a textview e a checkbox
        public class ViewholderMatematica_setimo_IV_Bimestre extends RecyclerView.ViewHolder {
            TextView myText;
            CheckBox mCB;
            LinearLayout layout_item_view;
            View mView;

            public ViewholderMatematica_setimo_IV_Bimestre(View itemView) {
                super(itemView);
                mView = itemView;
        ...
        @Override
        public void onBindViewHolder(final ViewholderMatematica_setimo_IV_Bimestre holder, final int position) {
        ...
        public void ExibeDialogOpcoes() {
            ...
            btn_abrir_anotacoes.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ((Main_activity) getActivity()).ano = "m_7ano";
                    String p = String.valueOf(position_check);
                    ((Main_activity) getActivity()).titulo = "m7a"+p+"_"+sTitulo_IV_Bimestre;
    ...
    public void onViewCreated (View view, Bundle savedInstanceState) {
        ...
        ((Main_activity) getActivity()).tab_obj_mat_setimo_(view);
