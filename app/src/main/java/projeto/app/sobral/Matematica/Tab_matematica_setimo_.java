...
public class Tab_matematica_setimo_ extends Fragment{
    ...
    RecyclerView rv_I_Bimestre_7_matematica;
    RecyclerView rv_II_Bimestre_7_matematica;
    RecyclerView rv_III_Bimestre_7_matematica;
    RecyclerView rv_IV_Bimestre_7_matematica;
    ...
    Adaptador_Disciplina_ano adp_matematica_setimo_1_bimestre;
    Adaptador_Disciplina_ano adp_matematica_setimo_2_bimestre;
    Adaptador_Disciplina_ano adp_matematica_setimo_3_bimestre;
    Adaptador_Disciplina_ano adp_matematica_setimo_4_bimestre;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rv_I_Bimestre_7_matematica = (RecyclerView) rView.findViewById(R.id.recyclerView_I_Bimestre);
        tv_Titulo_I_Bimestre = (TextView) rView.findViewById(R.id.Titulo_I_Bimestre);

        rv_I_Bimestre_7_matematica.setHasFixedSize(true);
        rv_I_Bimestre_7_matematica.setLayoutManager(new LinearLayoutManager(getActivity().getApplicationContext()));



        rv_I_Bimestre_7_matematica.setItemAnimator(new DefaultItemAnimator());
        rv_I_Bimestre_7_matematica.addItemDecoration(new DividerItemDecoration(getActivity().getApplicationContext(),LinearLayoutManager.VERTICAL));

        listData_1_bimestre=  new ArrayList<>();
        adp_matematica_setimo_1_bimestre = new Adaptador_Disciplina_ano(listData_1_bimestre);
        ...
        rv_II_Bimestre_7_matematica = (RecyclerView) rView.findViewById(R.id.recyclerView_II_Bimestre);
        tv_Titulo_II_Bimestre = (TextView) rView.findViewById(R.id.Titulo_II_Bimestre);

        rv_II_Bimestre_7_matematica.setHasFixedSize(true);
        rv_II_Bimestre_7_matematica.setLayoutManager(new LinearLayoutManager(getActivity().getApplicationContext()));
        rv_II_Bimestre_7_matematica.setItemAnimator(new DefaultItemAnimator());
        rv_II_Bimestre_7_matematica.addItemDecoration(new DividerItemDecoration(getActivity().getApplicationContext(),LinearLayoutManager.VERTICAL));

        listData_2_bimestre=  new ArrayList<>();
        adp_matematica_setimo_2_bimestre = new Adaptador_Disciplina_ano(listData_2_bimestre);
        ...
        rv_III_Bimestre_7_matematica = (RecyclerView) rView.findViewById(R.id.recyclerView_III_Bimestre);
        tv_Titulo_III_Bimestre = (TextView) rView.findViewById(R.id.Titulo_III_Bimestre);

        rv_III_Bimestre_7_matematica.setHasFixedSize(true);
        rv_III_Bimestre_7_matematica.setLayoutManager(new LinearLayoutManager(getActivity().getApplicationContext()));
        rv_III_Bimestre_7_matematica.setItemAnimator(new DefaultItemAnimator());
        rv_III_Bimestre_7_matematica.addItemDecoration(new DividerItemDecoration(getActivity().getApplicationContext(),LinearLayoutManager.VERTICAL));

        listData_3_bimestre=  new ArrayList<>();
        adp_matematica_setimo_3_bimestre = new Adaptador_Disciplina_ano(listData_3_bimestre);
        ...
        rv_IV_Bimestre_7_matematica = (RecyclerView) rView.findViewById(R.id.recyclerView_IV_Bimestre);
        tv_Titulo_IV_Bimestre = (TextView) rView.findViewById(R.id.Titulo_IV_Bimestre);

        rv_IV_Bimestre_7_matematica.setHasFixedSize(true);
        rv_IV_Bimestre_7_matematica.setLayoutManager(new LinearLayoutManager(getActivity().getApplicationContext()));
        rv_IV_Bimestre_7_matematica.setItemAnimator(new DefaultItemAnimator());
        rv_IV_Bimestre_7_matematica.addItemDecoration(new DividerItemDecoration(getActivity().getApplicationContext(),LinearLayoutManager.VERTICAL));

        listData_4_bimestre=  new ArrayList<>();
        adp_matematica_setimo_4_bimestre = new Adaptador_Disciplina_ano(listData_4_bimestre);

        //=================FIM DO TRATAMENTO DOS ADAPTADORES PARA CARREGAR A LISTA DE CONTEÚDOS DOS IV BIMESTRE==================


        rv_I_Bimestre_7_matematica.setNestedScrollingEnabled(false);
        rv_II_Bimestre_7_matematica.setNestedScrollingEnabled(false);
        rv_III_Bimestre_7_matematica.setNestedScrollingEnabled(false);
        rv_IV_Bimestre_7_matematica.setNestedScrollingEnabled(false);
    ...
    void GetDataFirebase(){
        ...
        DBR.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                rv_I_Bimestre_7_matematica.setAdapter(adp_matematica_setimo_1_bimestre);
            }
        ...
        DBR.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                rv_II_Bimestre_7_matematica.setAdapter(adp_matematica_setimo_2_bimestre);
            }
        ...
        DBR.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                rv_III_Bimestre_7_matematica.setAdapter(adp_matematica_setimo_3_bimestre);
            }
        ...
        DBR.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                rv_IV_Bimestre_7_matematica.setAdapter(adp_matematica_setimo_4_bimestre);
            }
