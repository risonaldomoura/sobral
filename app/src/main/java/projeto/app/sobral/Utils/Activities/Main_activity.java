...
import projeto.app.sobral.Utils.Classes.DatabasePersistence;
...
public class Main_activity extends AppCompatActivity
    ...
    public String text1;
    public Map<String, String> folderSet;
    ...
    private DatabaseReference TextShareFirebase;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProgress.setMessage("Sincronizando com o seu Google Docs app ...");
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.configuracoes) {
            ...
            shareIntent.putExtra(Intent.EXTRA_SUBJECT, "Compartilhe a Matriz com seus amigos!");
            shareIntent.putExtra(Intent.EXTRA_TEXT,"https://play.google.com/store/apps/details?id=projeto.app.sobral");
            ...
            webview.loadUrl("https://docs.google.com/document/d/1JRDgqzjBRrHIi9MCQab49BYRAcUXoqJdrf-nKy2BSbA/edit");
            */
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, List<String>> {
        ...
        private List<String> getDataFromApi()
            ...
            paramTituloTexto.add(disciplina);
            paramTituloTexto.add(ano);
            ...
            if (op.getResponse() != null &&
                ...
                folderSet = (Map<String, String>)(op.getResponse().get("result"));
    ...
    public void AbreGoogleDocApp(String url){
        WebView webview = new WebView(this);
